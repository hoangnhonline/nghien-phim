            ...
            <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="keywords" id="keywords">{{ old('keywords') }}</textarea>
              </div>  
              <div class="form-group">
                <label>Custom text</label>
                <textarea class="form-control" rows="10" name="custom_text" id="custom_text">{{ old('custom_text') }}</textarea>
              </div>
