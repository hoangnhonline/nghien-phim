...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default" href="{{ route('info-seo.index') }}" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="keywords" id="keywords">{{ $detail->keywords }}</textarea>
              </div>  
              <div class="form-group">
                <label>Custom text</label>
                <textarea class="form-control" rows="10" name="custom_text" id="custom_text">{{ $detail->custom_text }}</textarea>
              </div>
             <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  <label class="col-md-3 row">Image </label>    
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="{{ $detail->image_url ? Helper::showImage($detail->image_url) : URL::asset('be/dist/img/img.png') }}" class="img-thumbnail" width="145" height="85">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('info-seo.index')}}">Hủy</a>
            </div>
