    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('country.update') }}">
            {!! csrf_field() !!}
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Tên quốc gia <span class="red-star">*</span></label>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('country.index')}}">Hủy</a>
            </div>
