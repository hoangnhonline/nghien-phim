...
class FilmEpisodeController extends Controller
{
    ...
    */
    ...
    {  
        ...
        $items = FilmEpisode::orderBy('id')->get();        
        
        //$parentCate = Category::where('parent_id', 0)->where('type', 1)->orderBy('display_order')->get();
        
        return view('backend.film-eposide.index', compact('items'));
    }
    public function create()
    {         
        //$parentCate = Category::where('parent_id', 0)->where('type', 1)->orderBy('display_order')->get();

        return view('backend.film-eposide.create');
    }
    public function store(Request $request)
    {
        ...
        $this->validate($request,[
            'name' => 'required',
            'slug' => 'required|unique:film_episode,slug',
        ],
        [
        ...
        return redirect()->route('film-eposide.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.film-eposide.edit', compact( 'detail'));
    }
