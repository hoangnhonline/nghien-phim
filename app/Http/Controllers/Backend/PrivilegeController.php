...
class PrivilegeController extends Controller
{
    ...
    */
    ...
    {          
        ...
        $parentPrivilege = Privilege::where('parent_id', 0)->get();        
        
        $childArr = [];
        
        foreach($parentPrivilege as $parent){
            $childArr[$parent->id] = Privilege::where('parent_id', $parent->id)->orderBy('display_order')->get();
        }      
        
        return view('backend.privilege.index', compact('parentPrivilege', 'childArr', 'detail'));
    }
    ...
    public function store(Request $request)
    {
      ...
      //  $tmpPassword = str_random(10);
        ...
        Session::flash('message', 'Tạo mới tài khoản thành công. Mật khẩu : 1234@6');
